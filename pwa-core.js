...
.pwa-dismiss{display:table;margin:14px auto 0;padding:7px 22px;border-radius:12px;border:1px solid rgba(0,0,0,.12);background:rgba(0,0,0,.04);font-size:13px;font-weight:600;color:rgba(255, 0, 0, 1.00);cursor:pointer;}
  ...
  <div id="pwa-card">
    ...
    <div id="pwa-block-android" hidden>
      <div id="pwa-already-installed" hidden style="text-align:center;padding:18px 10px 10px;">
        ...
        <div style="font-size:18px;font-weight:800;color:#2d7a4f;margin-bottom:6px;">Đã được cài vào máy bạn</div>
        <div style="font-size:13px;color:rgba(0,0,0,.55);line-height:1.5;">Mở app từ màn hình chính để sử dụng<br>mà không cần vào link này nữa.</div>
      </div>
